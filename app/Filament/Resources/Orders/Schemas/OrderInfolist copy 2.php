            ...
            ->components([
                Section::make('Order overview')
                    ...
                    ->schema([
                        ...
                        TextEntry::make('shipping_status')->label('Fulfillment')->badge(),
                    ])
                    ...
                    Section::make('Customer note')
                        ...
                        ->schema([
                            TextEntry::make('address.note')
                                ->hiddenLabel()
                                ->placeholder('No note was added to this order.')
                                ->prose(),
                        ])
                        ->compact(),
                ])->columnSpan(['lg' => 2]),
                Group::make([
                    Section::make('Payment summary')
                        ...
                        ->schema([
                            TextEntry::make('subtotal_amount')->label('Subtotal')->money('USD')->inlineLabel(),
                            TextEntry::make('shipping_cost')->label('Shipping')->money('USD')->inlineLabel(),
